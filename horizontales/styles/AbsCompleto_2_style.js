...
var style_AbsCompleto_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetX = 8;
    var offsetY = 3;
    if (feature.get("Abscisa") !== null) {
        labelText = String(feature.get("Abscisa"));
    }
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(203,150,217,1.0)'})}),
...
function update() {
    ...
    var features = lyr_AbsCompleto_2.getSource().getFeatures();
