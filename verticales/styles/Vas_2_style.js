...
var style_Vas_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(252,252,88,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 3}),
...
function update() {
    ...
    var features = lyr_Vas_2.getSource().getFeatures();
